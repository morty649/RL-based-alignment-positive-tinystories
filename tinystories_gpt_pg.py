...
class StoryDataset(Dataset):
    ...
    def __init__(self, block_size, split="train", filter_sentiment=None, tokenizer=None):
        ...
        dataset = datasets.load_dataset("roneneldan/TinyStories", split=f"{split}[:200000]")
...
if __name__ == '__main__':
    ...
    torch.save(train_ds.tokenizer, "tokenizer.pt")
    ...
    train_config.compile = False # Use torch.compile for a speedup if available
    train_config.batch_size = 64 # Increase batch size if GPU memory allows
    ...
    trainer.device = device      #  IMPORTANT
